...
def evaluate_agent_all_tasks_env(num_batches, agent, env, train=False, eval_criterion=None):
    ...
    for i in range(env.number_tasks):
        ...
        res = evaluate_agent_task(num_batches, agent, test_data_iterator, eval_criterion)
...
def evaluate_agent_task(num_batches, agent, test_iter, eval_criterion):
