...
python experiment.py --device $1 --steps_per_task 1000 --number_tasks 10 --environment split --split_type classes --exp_id exp2-nrt1 --checkpoint_freq 1000 --network_name resnet18 --agent_type replay --wandb-project order2-approximations --multihead --experiment_type singletask --replay_fraction 1.0 --replay_type "fixed" --num_replay_tasks 1