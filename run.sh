...
python experiment.py --device $1 --steps_per_task 1000 --number_tasks 10 --environment split --split_type classes --exp_id exp2 --checkpoint_freq 1000 --network_name resnet18 --agent_type base --wandb-project order2-approximations --singlehead --experiment_type multitask
